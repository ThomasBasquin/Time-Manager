<template>
  <div class="h-full w-full md:w-2/5 flex justify-center items-center">
    <canvas ref="myChart" class="h-1/3 w-1/3 flex justify-center items-center"></canvas>
  </div>
</template>
  ...
  export default {
    ...
    methods: {
      ...
      calculateWorkHours() {
        ...
        const totalWorkHours = this.chartData.reduce(
